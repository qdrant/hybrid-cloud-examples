...
In order to use DigitalOcean k8s cluster as private region for hybrid qdrant cloud. 
You need to setup vpc and k8s custer. E.g use module  `digitalocean/terraform/modules/cluster-setup`
